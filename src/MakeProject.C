...
namespace ElmerFoamFSI 
{
  ...
  /// ElmerFoamFSI project template.
  ///
  /// Usage of this program should go like the following:
  /// 1. Get and Install the ElmerFoamFSI template.
  /// <blockquote>
  ///  svn co $IRREPO/ElmerFoamFSI/trunk ElmerFoamFSI\n
  ///  mkdir elmerfoamfsi_build\n
  ///  cd elmerfoamfsi_build\n
  ///  cmake ../ElmerFoamFSI\n
  ///  make\n
  ///  cd ../\n
  /// </blockquote>
  ...
  /// <blockquote>
  ///  elmerfoamfsi_build/bin/make_project ElmerFoamFSI <NewProject>\n
  /// </blockquote>
  ///
...
{
  return(ElmerFoamFSI::MakeProject(argc,argv));
}
