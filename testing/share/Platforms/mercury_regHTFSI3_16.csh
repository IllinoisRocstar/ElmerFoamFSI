...
set InputDir = HronTurekFsi3_16
set Outputs = ./fluid/probe_proc_8_nde_4.dat
set OutputsCheck = ./fluid/ref_4.dat
set TestName = HronTurekFSI3_16:Works
...
cd \${PBS_O_WORKDIR}
mpirun -np 16 -machinefile \${PBS_NODEFILE} ${BINDIR}/elmerfoamfsiPar -v 2 test.config
echo "1" >> regHTFSI3Finished
exit 0
EOF
